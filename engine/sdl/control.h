...
#include "joysticks.h"
	...
	#define	CONTROL_DEFAULT1_FIRE2		SDL_SCANCODE_F
	...
	#define	CONTROL_DEFAULT1_FIRE6		SDL_SCANCODE_D
	...
	#define	CONTROL_DEFAULT1_FIRE2		SDLK_f
	#define	CONTROL_DEFAULT1_FIRE3		SDLK_z
	#define	CONTROL_DEFAULT1_FIRE4		SDLK_x
	#define	CONTROL_DEFAULT1_FIRE5		SDLK_s
	#define	CONTROL_DEFAULT1_FIRE6		SDLK_d
	#define	CONTROL_DEFAULT1_SCREENSHOT	SDLK_F12
